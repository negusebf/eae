    ...
    if request.method == 'POST':
        ...
        if flag == True:
            ...
            send_mail(
                ...
                'Hi '+str(sub_email)+'! Thank you for subscribing to our newslater. You will now receive daily updates on our archive. Feel free also to contact us for any kind of help or feedback. If you wich to unsubscribe, please go to your settings page.',
