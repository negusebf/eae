...
from management.models import EmailSender
...
def EmailNotificationSender(request):
    retrieve_data = EmailSender.objects.filter(sent_on__isnull=True, to__isnull=False)
    send_now = EmailSender()


    subject = 'Negusse Test Website (AUTOMATIC EMAIL SENDER)' 
    from_email = 'negusebf12@gmail.com'
